...
function generarTicket(pedido) {
    ...
    contenido.innerHTML = `
        ...
        <div class="ticket-footer">
            ...
            ❤️ Gracias por preferir a FrostNat Helados ❤️
...
Gracias por preferir a FrostNat Helados ❤️`;
...
function enviarCorreo() {
    ...
    const asunto =
        ...
        `Pedido #${ultimoPedido.numero} - FrostNat Helados`;
...
Gracias por preferir a FrostNat Helados
