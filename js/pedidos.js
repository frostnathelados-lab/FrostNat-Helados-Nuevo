...
function calcularPedido() {
    ...
    const salsaBase =
        document.getElementById("salsaBase").value;
    const sabor =
...
function mostrarResumen(
    ...
    resultado.innerHTML = `
        ...
        <p><strong>SalsaBase:</strong> ${salsaBase}</p>
...
function limpiarFormulario() {
    ...
    document.getElementById("salsaBase").selectedIndex = 0;
     document.getElementById("sabor").selectedIndex = 0;
